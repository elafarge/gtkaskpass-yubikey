...
buildGoModule {
  ...
  vendorHash = "sha256-8LDA6oxjSvOtxBFHKp5pG0hKt7w+pV9AIVWsyizw7ao=";
  ...
  checkPhase = ''
    ...
    go vet ./...
    go test ./...
    go test -race ./internal/app ./internal/askpass ./internal/cache ./internal/cacheipc ./internal/lifecycle ./internal/trace ./internal/preferences ./internal/service ./internal/touch
    runHook postCheck
  '';
  postInstall = ''
